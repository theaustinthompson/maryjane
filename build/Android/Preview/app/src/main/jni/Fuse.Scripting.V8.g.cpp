...
// C:\Users\borde_000\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.7.2\V8\Array.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\borde_000\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.7.2\V8\Handle.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\borde_000\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.7.2\V8\V8SimpleExtensions.uno
// -------------------------------------------------------------------------------------------------------------
...
// C:\Users\borde_000\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.7.2\V8\Context.uno
// --------------------------------------------------------------------------------------------------
...
// C:\Users\borde_000\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.7.2\V8\Debugger.uno
// ---------------------------------------------------------------------------------------------------
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:/Users/borde_000/AppData/Local/Fusetools/Packages/Fuse.Scripting.JavaScript/1.7.2/V8/Debugger.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[0/*"DEBUG_V8: C...*/], 0, ::STRINGS[1/*"C:/Users/bo...*/], 246);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
    ...
    {
        {
            ...
            if (i >= 0)
            {
                ...
                if (contentLength > 0)
                {
                    ...
                    ::g::Fuse::Scripting::IThreadWorker::Invoke(uInterface(uPtr(uPtr(uPtr(_parent)->_context)->ThreadWorker()), ::TYPES[7/*Fuse.Scripting.IThreadWorker*/]), uDelegate::New(::TYPES[8/*Uno.Action<Fuse.Scripting.Context>*/], (void*)Debugger__Connected__ProcessMessages_fn, this));
                }
            }
            else
            {
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log3(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("DEBUG_V8: Waiting for a debugger agent to connect on port "), uBox<int32_t>(::TYPES[9/*int*/], parent->_port)), uString::Const("...")), 0, ::STRINGS[1/*"C:/Users/bo...*/], 87);
...
uObject* Debugger::ToConnected(Debugger* parent, ::g::Uno::Net::Sockets::Socket* communicationSocket)
{
    ...
    writer->Write9(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Type: connect\r\n"
        ...
        "Protocol-Version: 1\r\n"
        "Embedding-Host: ")), uString::Const("Fuse.Scripting.JavaScript")), uString::Const(" ")), uString::Const("1.7.2")), uString::Const("\r\n"
        "Content-Length: 0\r\n"
        "\r\n"
        "")));
...
// C:\Users\borde_000\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.7.2\V8\Function.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\borde_000\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.7.2\V8\Object.uno
// -------------------------------------------------------------------------------------------------
